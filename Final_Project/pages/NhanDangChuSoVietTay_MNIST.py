...
st.set_page_config(
    page_title="Hand Writing Detection",
    page_icon="👋",
)
...
add_bg_from_local('E:/TAI_LIEU_DAI_HOC/SEMESTER_6/XuLyAnh/FinalProject/Background/HandWriting.png')  
st.markdown("""
<style>
...
if 'is_load' not in st.session_state:
    # load model
    model_architecture = 'E:/TAI_LIEU_DAI_HOC/SEMESTER_6/XuLyAnh/FinalProject/ModelNhanDangChuSoVietTay/digit_config.json'
    model_weights = 'E:/TAI_LIEU_DAI_HOC/SEMESTER_6\XuLyAnh/FinalProject/ModelNhanDangChuSoVietTay/digit_weight.h5'
