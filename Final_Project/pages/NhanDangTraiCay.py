...
add_bg_from_local('E:/TAI_LIEU_DAI_HOC/SEMESTER_6/XuLyAnh/FinalProject/Background/Fruit.png')  
st.markdown("""
<style>
...
try:
    ...
    st.session_state["Net"] = cv2.dnn.readNet("E:/TAI_LIEU_DAI_HOC/SEMESTER_6/XuLyAnh/FinalProject/ModelNhanDangTraiCay/yolov8n_trai_cay.onnx")
...
filename_classes = 'E:/TAI_LIEU_DAI_HOC/SEMESTER_6/XuLyAnh/FinalProject/ModelNhanDangTraiCay/object_detection_classes_yolo.txt'
mywidth  = 640
myheight = 640
...
if img_file_buffer is not None:
    ...
    if st.button('Predict'):
        classes = ['buoi', 'sau_rieng', 'tao', 'thanh_long', 'thom']
