...
add_bg_from_local('E:/TAI_LIEU_DAI_HOC/SEMESTER_6/XuLyAnh/FinalProject/Background/Hand.png')  
st.markdown("""
<style>
    [data-testid=stSidebar] {
        background-color: #7F736A;
    }
    .stImage > div:first-child {
    transform: translateY(50px); /* Số lượng pixel bạn muốn dịch chuyển */
    }
</style>
""", unsafe_allow_html=True)
...
def main():
    ...
    while True:
        ...
        #shift_amount = 50  # Số lượng pixel bạn muốn dịch xuống
        #image_rgb_shifted = np.roll(image_rgb, shift_amount, axis=0)
