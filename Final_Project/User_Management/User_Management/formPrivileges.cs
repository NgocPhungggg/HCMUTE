...
namespace User_Management
{
    public partial class formPrivileges : Form
    {
        ...
        private void load()
        {
            ...
            DataTable dataTable_DistinctAllRoles = role.GetAllRole();
        ...
        private void dataGridViewObjectPrivileges_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            string object_privileges = dataGridViewObjectPrivileges.Rows[r].Cells[1].Value.ToString();
            textBox_RoleUser.Text = role_name;
        ...
        private void button_GrantSystem_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                bool result = false;
                result = privileges.GrantPrivileges_System(ref err, system_privileges, role_user, option);
