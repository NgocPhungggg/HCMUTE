...
namespace Data_Access_Layer
{
    public class DAL
    {
        ...
        public int ExecuteScalar(string strSQL, CommandType ct, ref string error, string[] parameterNames, object[] parameterValues)
        {
            int result = 0;
            try
            {
                ...
                using (OracleConnection connection = new OracleConnection(currentConnectionString))
                {
                    ...
                    using (OracleCommand command = new OracleCommand(strSQL, connection))
                    {
                        ...
                        if (resultScalar != null && resultScalar != DBNull.Value)
                        {
        ...
        //public void LogoutExecuteQuery()
        //{
        //    string currentConnectionString = GetConnectionString();
        //    if (string.IsNullOrEmpty(currentConnectionString))
        //    {
