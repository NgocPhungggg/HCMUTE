...
namespace Business_Logic_Layer
{
    public class Privileges
    {
        ...
        public DataTable GetAllColumsOfINFO()
        {
            string query = "SELECT COLUMN_NAME FROM USER_TAB_COLUMNS WHERE TABLE_NAME = 'INFO'";
            return dal.ExecuteQuery(query);
        }
        ...
        public bool GrantPrivileges_System(ref string err,
                                            string privilege,
                                            string grantee, 
                                            bool option)
        {
            return dal.ExecuteNonQuery(
                ...
                ref err,
                new string[] { "p_action", "p_privilege", "p_grantee", "p_with_option" },
                                                ...
                                                bool option)
        {
            return dal.ExecuteNonQuery(
                ...
                CommandType.StoredProcedure,
                ref err,
                new string[] { "p_action", "p_privilege", "p_grantee", "p_object_name", "p_column_name","p_with_option" },
                new object[] { "GRANT", privilege, grantee, object_name, column_name, option}
            );
        }
                                                ...
                                                string column_name)
        {
            return dal.ExecuteNonQuery(
                ...
                CommandType.StoredProcedure,
                ref err,
                new string[] { "p_action", "p_privilege", "p_grantee", "p_object_name", "p_column_name" },
                new object[] { "REVOKE", privilege, grantee, object_name, column_name}
            );
        }
