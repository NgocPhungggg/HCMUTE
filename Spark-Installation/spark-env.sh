...
JAVA_HOME=S:\Works\Java\jdk-1.8
#SCALA_HOME=C:\Scala
SPARK_HOME=C:\Spark\spark-3.5.3-bin-hadoop3
HADOOP_HOME=C:\Hadoop\hadoop-3.3.6
SPARK_MASTER_HOST=192.168.1.61
SPARK_WORKER_CORES=8
SPARK_LOCAL_IP=MASTER-IP
PATH=%JAVA_HOME%\bin;%SCALA_HOME%\bin;%SPARK_HOME%\bin;%HADOOP_HOME%\bin;%PATH%
